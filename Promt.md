...
- Бесплатное ТО на станции (3 раза в месяц)
...
- Проверка статуса велосипеда
- Проверка состояния станции

Exchange Process:
1. Сканирование успешно → Информация о станции
2. Выбор ячейки из доступных
3. Фотофиксация текущего велосипеда
4. Отчет о состоянии (повреждения, проблемы)
5. Подтверждение обмена
6. Процесс разблокировки ячеек
7. Получение нового велосипеда
8. Финальная фотофиксация
9. Электронный чек операции

Error Handling:
- Неверный QR код
- Станция недоступна
- Нет свободных велосипедов
...
- Цветовая индикация станций:
  * Зеленый: >5 велосипедов доступно
  * Желтый: 1-5 велосипедов
  * Красный: нет велосипедов
