 ...
 * );
 */
export declare const EditBase: <RecordType extends RaRecord = any, ErrorType = Error>({ children, render, loading, ...props }: EditBaseProps<RecordType, ErrorType>) => string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element | null;
