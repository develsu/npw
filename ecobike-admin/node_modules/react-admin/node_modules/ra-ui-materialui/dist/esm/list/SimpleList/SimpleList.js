...
import { ListIterator, sanitizeListRestProps, useGetRecordRepresentation, useListContextWithProps, useRecordContext, useResourceContext, useTranslate, } from 'ra-core';
...
export var SimpleList = function (inProps) {
    ...
    return (React.createElement(Root, __assign({ className: className }, sanitizeListRestProps(rest)),
        React.createElement(ListIterator, { data: data, total: total, render: function (record, rowIndex) { return (React.createElement(SimpleListItem, { key: record.id, rowIndex: rowIndex, linkType: linkType, rowClick: rowClick, rowSx: rowSx, rowStyle: rowStyle, resource: resource },
