...
var ReferenceOneField = function (inProps) {
    ...
    return (react_1.default.createElement(ra_core_1.ReferenceOneFieldBase, __assign({}, props, { empty: emptyText ? (typeof emptyText === 'string' ? (react_1.default.createElement(material_1.Typography, { component: "span", variant: "body2" }, emptyText &&
            translate(emptyText, { _: emptyText }))) : (emptyText)) : typeof empty === 'string' ? (react_1.default.createElement(material_1.Typography, { component: "span", variant: "body2" }, empty && translate(empty, { _: empty }))) : (empty !== null && empty !== void 0 ? empty : null) }),
