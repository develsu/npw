...
var SingleFieldList = function (inProps) {
    ...
    return (React.createElement(Root, __assign({ gap: gap, direction: direction, className: className }, (0, ra_core_1.sanitizeListRestProps)(rest)),
        React.createElement(ra_core_1.ListIterator, { data: data, total: total, isPending: isPending, render: function (record) {
                ...
                if (resourceLinkPath) {
                    return (React.createElement(Link_1.Link, { className: exports.SingleFieldListClasses.link, to: resourceLinkPath, onClick: stopPropagation }, children || (React.createElement(DefaultChildComponent, { clickable: true }))));
                }
