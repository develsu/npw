...
var SimpleList = function (inProps) {
    ...
    return (React.createElement(Root, __assign({ className: className }, (0, ra_core_1.sanitizeListRestProps)(rest)),
        React.createElement(ra_core_1.ListIterator, { data: data, total: total, render: function (record, rowIndex) { return (React.createElement(SimpleListItem_1.SimpleListItem, { key: record.id, rowIndex: rowIndex, linkType: linkType, rowClick: rowClick, rowSx: rowSx, rowStyle: rowStyle, resource: resource },
