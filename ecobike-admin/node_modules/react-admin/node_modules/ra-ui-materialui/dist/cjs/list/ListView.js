...
var ListView = function (props) {
    var _a = props.actions, actions = _a === void 0 ? defaultActions : _a, aside = props.aside, filters = props.filters, emptyWhileLoading = props.emptyWhileLoading, _b = props.pagination, pagination = _b === void 0 ? defaultPagination : _b, children = props.children, className = props.className, _c = props.component, Content = _c === void 0 ? DefaultComponent : _c, title = props.title, _d = props.empty, empty = _d === void 0 ? defaultEmpty : _d, render = props.render, rest = __rest(props, ["actions", "aside", "filters", "emptyWhileLoading", "pagination", "children", "className", "component", "title", "empty", "render"]);
    var listContext = (0, ra_core_1.useListContext)();
    var defaultTitle = listContext.defaultTitle, data = listContext.data, error = listContext.error, isPending = listContext.isPending, filterValues = listContext.filterValues, resource = listContext.resource, total = listContext.total, hasNextPage = listContext.hasNextPage, hasPreviousPage = listContext.hasPreviousPage;
    ...
    var renderList = function () { return (React.createElement("div", { className: exports.ListClasses.main },
        ...
        React.createElement(Content, { className: exports.ListClasses.content }, render ? render(listContext) : children),
