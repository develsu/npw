...
var EditView = function (props) {
    var _a;
    var actions = props.actions, aside = props.aside, children = props.children, render = props.render, className = props.className, _b = props.component, Content = _b === void 0 ? material_1.Card : _b, _c = props.emptyWhileLoading, emptyWhileLoading = _c === void 0 ? false : _c, title = props.title, rest = __rest(props, ["actions", "aside", "children", "render", "className", "component", "emptyWhileLoading", "title"]);
    var hasShow = (0, ra_core_1.useResourceDefinition)().hasShow;
    var editContext = (0, ra_core_1.useEditContext)();
    var resource = editContext.resource, defaultTitle = editContext.defaultTitle, record = editContext.record, isPending = editContext.isPending;
