 ...
 * );
 */
export declare const ShowBase: <RecordType extends RaRecord = any>({ children, render, loading, ...props }: ShowBaseProps<RecordType>) => string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element | null;
