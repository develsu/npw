...
var ReferenceManyFieldBase = function (props) {
    ...
    if (controllerProps.error && error) {
        return (react_1.default.createElement(core_1.ResourceContextProvider, { value: reference },
            react_1.default.createElement(ListContextProvider_1.ListContextProvider, { value: controllerProps }, error)));
    }
    if (
    ...
    return (react_1.default.createElement(core_1.ResourceContextProvider, { value: reference },
        react_1.default.createElement(ListContextProvider_1.ListContextProvider, { value: controllerProps }, render ? render(controllerProps) : children)));
};
