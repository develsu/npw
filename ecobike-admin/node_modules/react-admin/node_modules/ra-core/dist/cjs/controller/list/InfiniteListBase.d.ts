 ...
 * );
 */
export declare const InfiniteListBase: <RecordType extends RaRecord = any>({ children, render, loading, ...props }: InfiniteListBaseProps<RecordType>) => string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element | null;
