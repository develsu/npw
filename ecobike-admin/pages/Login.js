...
export default function Login(){
  ...
  const role=document.createElement('select');role.dataset.testid='roleSelect';['admin','operator','support','viewer'].forEach(r=>{const o=document.createElement('option');o.value=r;o.textContent=r;role.appendChild(o);});
  const btn=document.createElement('button');btn.type='submit';btn.textContent=t('login.signIn');
  btn.dataset.testid='btnLogin';
